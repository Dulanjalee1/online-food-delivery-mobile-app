...
//        val cartItemImageResourceId = getCartItemImageResorceId(_cartItem.itemImage)
//        cartItemImageView.setImageResource(cartItemImageResourceId)
